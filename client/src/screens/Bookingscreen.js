...
function Bookingscreen({match}) {
    ...
    async function tokenHander(token) {
        ...
        try {
            ...
            Swal.fire('Congrats' , 'Your Room has booked succeessfully' , 'success')
            {
                const btnPay = document.querySelector(".btn-pay")
                btnPay.style.display = "none";
                btnPay.innerHTML = "Room Booked";
                const bookedMsg = document.querySelector(".booked-msg")
                bookedMsg.style.display = "block";
            }
            ...
            {loading ? (<Loader/>) : error ? (<Error/>) : (
                ...
                <div className="row p-3 mb-5 bs" data-aos='flip-right' duration='2000'>
                      ...
                      <div className="col-md-6 text-right">
                           ...
                           <h1 className='booked-msg' style={{display:"none", color:"green"}}><b>Room Booked Successfully</b></h1>

                           <StripeCheckout
            amount={totalAmount*100}
            shippingAddress
            token={tokenHander}
            stripeKey='pk_test_51M8MJMSJ337mPkdwRw8Q8DJmM82fGj4lmKLslytOxsiIKpMNNZJWGlCUTV0UXTqvJlaYqOvKruIioAdr9vp9Dd2Q00sRjKdSM7'
            currency='INR'
            >
